...
*证明*：令$k=(a,b)$，那么$a=k*a', b=k*b', r_1=a-n_1*b=k(a'-n_1b')$，显然$k|b, k|r_1$，也就是说$k$是$b$和$r_1$的公约数。假定存在$k'\gtk$，而且也是$b$和$r_1$的一个更大的公约数，那么$a$也将有$k'$这个因子，因此$(a,b)=k'$，与题设矛盾。所以$k$就是$b, r_1$的最大公约数。QED。
...
因为我们是在求**正整数解**，所以$0\le x\le 25, 0\le y\le 31$，而$-31.25\le k \le -25$。
