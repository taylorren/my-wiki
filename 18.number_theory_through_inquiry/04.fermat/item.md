...
网上有很多资源可以计算欧拉的$\phi(n)$值，比如[这里](http://www.javascripter.net/math/calculators/eulertotientfunction.htm)，据说可以算到20位数。
